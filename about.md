...
<a href="{{ site.baseurl }}/Rohit Gudi.pdf" class="download-button" style="display: inline-block; padding: 10px 20px; background-color: var(--primary-color); color: white; text-decoration: none; border-radius: 4px; margin: 20px 0;">
